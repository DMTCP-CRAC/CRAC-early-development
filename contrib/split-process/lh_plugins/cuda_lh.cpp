...
resume()
{
  printf("CUDA: in resume\n");
  fflush(stdout);
}

static void
cuda_EventHook(LhEvent_t event, LhEventData_t *data)
{
  switch (event) {
  case LH_EVENT_INIT:
    init_msg();
...
static LhPluginDescriptor_t cudaPlugin = {
