...
void runTest(int argc, char **argv)
{
  ...
  cudaMallocPitch((void **) &d_idataPL,
                                  &d_pitchBytes,
                                  nx * sizeof(float),
                                  ny);
  ...
  cudaBindTextureToArray(texRefArray,
                                         d_idataArray,
                                         channelDesc);
